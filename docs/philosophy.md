...
This project has driven so much joy for me, to say the least, I hope it brings joy to those who find it someday too.

## Philosophy of information distrubution
These articles are written in plain-text markdown, becuase they are designed to be accessible through multiple domains.

1. This wiki should be readable from any system
2. Local-folder plain-text
